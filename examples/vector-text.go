...
func init() {
	...
	centered := game.NewGameObject("letters",
		gb.WithPosition(float32(rl.GetScreenWidth()/2), 420),
		gb.WithOrigin(0.5, 0.5),
		gb.WithScale(6, 6)).
		NewVecText("ABCDEFGHIJKLMNOPQRSTUVWXYZ", 0.5, 1, rl.Blue)
