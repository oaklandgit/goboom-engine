...
func NewApproach(
	obj *boom.GameObj,
	others []string,
	opts ...ApproachOption) *boom.GameObj {
...
func (a *Approach) IsMovingTowards(o *boom.GameObj) bool {

	dir := rl.Vector2Subtract(o.PosGlobal(), a.GameObj.PosGlobal())
	dir = rl.Vector2Normalize(dir)
	dot := rl.Vector2DotProduct(
		a.GameObj.Components["motion"].(*boom.Motion).Velocity, dir)

	return dot > 0 // moving towards if > 0
}

func (a *Approach) IsPointingToward(o *boom.GameObj) bool {
...
func (a *Approach) IsClose(target *boom.GameObj) bool {
...
func (a *Approach) IsSafeSpeed() bool {
	shipVel := a.GameObj.Components["motion"].(*boom.Motion).Velocity
...
func (a *Approach) Draw() {
	...
	targetAngle := boom.CalculateAngle(
		a.Target.PosGlobal(),
		a.Target.Parent.PosGlobal())
